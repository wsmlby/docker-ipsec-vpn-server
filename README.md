...
# This image is based on  hwdsl2/docker-ipsec-vpn-server, support ChromeOS only
...
*Read this in other languages: [English](https://github.com/wsmlby/docker-ipsec-vpn-server), [简体中文](https://github.com/wsmlby/docker-ipsec-vpn-server/blob/master/README-zh.md).*

#### Table of Contents

- [Install Docker](https://github.com/wsmlby/docker-ipsec-vpn-server#install-docker)
- [Download](https://github.com/wsmlby/docker-ipsec-vpn-server#download)
- [How to use this image](https://github.com/wsmlby/docker-ipsec-vpn-server#how-to-use-this-image)
- [Next steps](https://github.com/wsmlby/docker-ipsec-vpn-server#next-steps)
- [Important notes](https://github.com/wsmlby/docker-ipsec-vpn-server#important-notes)
- [Update Docker image](https://github.com/wsmlby/docker-ipsec-vpn-server#update-docker-image)
- [Advanced usage](https://github.com/wsmlby/docker-ipsec-vpn-server#advanced-usage)
- [Technical details](https://github.com/wsmlby/docker-ipsec-vpn-server#technical-details)
- [See also](https://github.com/wsmlby/docker-ipsec-vpn-server#see-also)
- [License](https://github.com/wsmlby/docker-ipsec-vpn-server#license)
...
Get the trusted build from the [Docker Hub registry](https://hub.docker.com/r/wsmlby/ipsec-vpn-server/):

```
docker pull wsmlby/ipsec-vpn-server
```

Alternatively, you may [build from source code](https://github.com/wsmlby/docker-ipsec-vpn-server#build-from-source-code) on GitHub.

## How to use this image

### Environment variables

This Docker image uses the following three variables, that can be declared in an `env` file ([example](https://github.com/wsmlby/docker-ipsec-vpn-server/blob/master/vpn.env.example)):
...
This will create a user account for VPN login, which can be used by your multiple devices[*](https://github.com/wsmlby/docker-ipsec-vpn-server#multi-device-note) . The IPsec PSK (pre-shared key) is specified by the `VPN_IPSEC_PSK` environment variable. The VPN username is defined in `VPN_USER`, and VPN password is specified by `VPN_PASSWORD`.
...
*Read this in other languages: [English](https://github.com/wsmlby/docker-ipsec-vpn-server#important-notes), [简体中文](https://github.com/wsmlby/docker-ipsec-vpn-server/blob/master/README-zh.md#重要提示).*
...
Before editing any VPN config files, you must first [start a Bash session](https://github.com/wsmlby/docker-ipsec-vpn-server#bash-shell-inside-container) in the running container.
